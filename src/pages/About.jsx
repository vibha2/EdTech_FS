...
const About = () => {
  return (
    <div>
    <div className='mt-[100px] relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center 
    text-white justify-between'>
       ...
       <StatsComponent/> 
        ...
        {/* section 5 */}
        <section className='mx-auto flex flex-col items-center justify-between gap-5 mb-[140px] mt-[100px]'>
            <LearningGrid />
            <ContactFormSection />
        </section>
